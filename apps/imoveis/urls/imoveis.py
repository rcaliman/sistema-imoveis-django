...
from apps.imoveis.views.imovel import imoveis_lista, imoveis_ordenados, imoveis_recibos
from apps.imoveis.views.imovel import imovel_inserir, imovel_alterar, imovel_apagar
